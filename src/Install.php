...
class Install
{
    ...
    {
        echo 'Gaia-UCenter installation successful, please execute `php gaia vendor:publish gaia\ucenter`' . PHP_EOL;
    }
    ...
    {
        echo 'Gaia-UCenter upgrade successful, please execute `php gaia vendor:publish gaia\ucenter`' . PHP_EOL;
    }
